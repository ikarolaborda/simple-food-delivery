...
const authUserName = ref(props.auth?.user?.name)
const authUserEmail = ref(props.auth?.user?.email)
...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div v-if="authUser" class="hidden sm:flex sm:items-center sm:ml-6">
                            <Link
                                v-if="can('cart.add')"
                ...
                >
                    ...
                    <div v-if="authUser" class="pt-4 pb-1 border-t border-gray-200">
                        <div class="px-4">
                            ...
                            <div class="font-medium text-sm text-gray-500">{{ authUserEmail }}</div>
                        </div>
            ...
            <!-- Page Content -->
            <main>
                <div v-if="statusMessage" class="max-w-7xl mx-auto pt-6 px-4 sm:px-6 lg:px-8">
